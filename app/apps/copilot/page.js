  ...
  const startNewChat = async () => {
    ...
    setTimeout(() => {
      const welcomeMessage = user ? 
        ...
        `👋 Welcome to ${APP_NAME}! I'm your AI monetization expert. You have ${QUESTION_LIMIT - questionCount} free questions remaining.`;
    ...
    <div className="app">
      ...
      <header className="header">
        <div className="header-content">
          <Link href="/" className="logo" title="Back to Purple Giraffe">
